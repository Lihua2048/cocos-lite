...
export class GameBuilder {
    constructor(scenes, resourceManager, outputDir = './game') {
     ...
     * 生成游戏运行时代码
     */
    generateGameRuntime(platform = 'h5') {
        return `
// 游戏运行时 - ${platform}
