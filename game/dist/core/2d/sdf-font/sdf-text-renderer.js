...
export class SDFTextRenderer {
     ...
     */
    drawText(text, x, y, options, program) {
        if (!this.fontTexture)
            return;
        const gl = this.gl;
        ...
        const baseline = this.fontMeta.base || this.fontMeta.lineHeight || (this.fontMeta.size || 32);
...
//# sourceMappingURL=sdf-text-renderer.js.map